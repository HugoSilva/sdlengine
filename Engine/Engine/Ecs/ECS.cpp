...
namespace ecs
{
	...
	EntityHandle ECS::makeEntity(ComponentBase** entityComponents, const unsigned int* componentIDs, size_t numComponents)
	{
	...
	void ECS::addComponentInternal(EntityHandle handle, std::vector<std::pair<unsigned int, unsigned int> >& entity, unsigned int componentID, ComponentBase* component)
	{
	...
	void ECS::updateSystemWithMultipleComponents(unsigned int index, SystemList& systems, float delta,
